...
function Navbar(){
    ...
    const navbarMenuItems = [["HOME", "/"], ["ABOUT", "/oops"], ["PROJECTS", "/oops"], ["CONTACT", "/oops"]]
    ...
    <nav className="m-10 flex flex-col md:flex-row place-content-between pr-2">
        <div className='md:inline-flex md:self-center'>
            ...
            <h1 id="title" className="inline-block pr-2 md:pl-3 text-4xl font-mono transition ease-in-out hover:opacity-60 duration-300 "> <a href="https://github.com/red-peel"> &#123;ELIAS_GONZALEZ&#125; </a> </h1>
        </div>
